...
def main() -> None:
    ...
    parser.add_argument("--topk-terms", type=int, default=256)     
    parser.add_argument("--topk-sim", type=int, default=50)
    parser.add_argument("--half-life-days", type=float, default=90.0)
    parser.add_argument("--min-sim", type=float, default=0.05)
